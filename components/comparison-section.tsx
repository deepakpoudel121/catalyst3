    ...
    <section className="py-32 px-6 relative overflow-hidden" id="services">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <div className="bg-white bg-opacity-5 backdrop-blur-sm border border-white border-opacity-10 rounded-3xl p-8 space-y-6">
          ...
          <div className="bg-cyan-400 bg-opacity-10 backdrop-blur-sm border border-cyan-400 border-opacity-30 rounded-3xl p-8 space-y-6 relative overflow-hidden">
